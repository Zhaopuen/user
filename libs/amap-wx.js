...
t.prototype.getWxLocation = function(t, e) {
    ...
    function e(e) {
        ...
        wx.request({
            url: "httpss://restapi.amap.com/v3/geocode/regeo",
            data: {
                key: o.key,
                location: e,
                extensions: "all",
    ...
    function e(e) {
        ...
        t.type && "forecast" == t.type && (o = "all"), wx.request({
            url: "httpss://restapi.amap.com/v3/weather/weatherInfo",
            data: {
                key: a.key,
                city: e,
                extensions: o,
    ...
    function e(e) {
        ...
        wx.request({
            url: "httpss://restapi.amap.com/v3/place/around",
            data: s,
            method: "GET",
            header: {
                "content-type": "application/json"
    ...
    var o, a = this, s = [], i = "httpss://restapi.amap.com/v3/staticmap?";
    ...
    wx.request({
        url: "httpss://restapi.amap.com/v3/assistant/inputtips",
        data: a,
        method: "GET",
        header: {
            "content-type": "application/json"
    ...
    wx.request({
        url: "httpss://restapi.amap.com/v3/direction/driving",
        data: a,
        method: "GET",
        header: {
            "content-type": "application/json"
    ...
    t.origin && (a.origin = t.origin), t.destination && (a.destination = t.destination), 
    wx.request({
        url: "httpss://restapi.amap.com/v3/direction/walking",
        data: a,
        method: "GET",
        header: {
            "content-type": "application/json"
    ...
    wx.request({
        url: "httpss://restapi.amap.com/v3/direction/transit/integrated",
        data: a,
        method: "GET",
        header: {
            "content-type": "application/json"
    ...
    t.origin && (a.origin = t.origin), t.destination && (a.destination = t.destination), 
    wx.request({
        url: "httpss://restapi.amap.com/v3/direction/riding",
        data: a,
        method: "GET",
        header: {
            "content-type": "application/json"
